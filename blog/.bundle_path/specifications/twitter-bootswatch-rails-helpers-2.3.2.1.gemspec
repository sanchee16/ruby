# -*- encoding: utf-8 -*-
# stub: twitter-bootswatch-rails-helpers 2.3.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "Twitter Bootswatch Rails Helpers gem for use with the twitter-bootswatch-rails.gem"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<twitter-bootswatch-rails>, ["~> 2.3.2"])
    else
      s.add_dependency(%q<twitter-bootswatch-rails>, ["~> 2.3.2"])
    end
  else
    s.add_dependency(%q<twitter-bootswatch-rails>, ["~> 2.3.2"])
  end
